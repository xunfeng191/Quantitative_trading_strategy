// fmz@a3dcf14386f16148d6d406128d6900ff
// 千千量化
...
function visuallize()
{
    var table = { 
        ...
        rows: [ 
            [initAmount,_N(account.Stocks,4),_N(center-1.2*priceInterval*orderAmount,4),_N(center+1.2*priceInterval*orderAmount,4),_N(center,4),_N(centerNow,4)],
            ['最后更新时间',_D(),'利润',_N(account.Stocks-initAmount,4),'收益率',_N((account.Stocks-initAmount)*100/initAmount,4)+'%'+'#FF0000'],
